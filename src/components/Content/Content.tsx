        ...
        <div className={styles.content}>
            <div className={styles.cont}>
                <div className={styles.mainContent}>
                    ...
                    <div className={styles.title}>Tasty Flavors <img src={title_img} alt="" /></div>
                    <div className={styles.title}>from Around the</div>
                    <div className={styles.title}> <img src={title_img} alt="" /> World</div>
                    <div className={styles.title_2}><b>Harmony House Kitchen:</b> Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    </div>
                    <div></div>
                </div>
